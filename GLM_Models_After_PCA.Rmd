...
```{r}
results_test <- glmer(as.factor(in_hosp_death) ~ Platelets + Urine + PaO2 + BUN + WBC + Age + (1 + Interval | subjid),family = binomial(link = "logit"), data = mean_test, na.action = na.omit)
