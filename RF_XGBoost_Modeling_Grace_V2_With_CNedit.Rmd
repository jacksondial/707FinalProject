...
rfm_pred = predict(rfm_interval1, imputed_test_clean_interval1[-32], type = "prob")
...
# Dependent variable for train
y_train = data.matrix(train_data_bl[, 4]) 

# Independent variables for test
X_test = data.matrix(test_data_bl[, -4])

# Dependent variable for test
y_test = data.matrix(test_data_bl[, 4]) 
...
set.seed(11022009)
# XGBoost Model # -- ISSUE WITH XGBOOST 
# Train an xgboost model using our training data - outputs training error
